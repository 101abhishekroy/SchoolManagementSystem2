...
namespace SchoolManagementSystem2.Controllers
{
    public class AttendancesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AttendanceID,StudentID,CourseID,Date,IsPresent")] Attendance attendance)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AttendanceID,StudentID,CourseID,Date,IsPresent")] Attendance attendance)
        {
